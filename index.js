...
const convertion = {"espresso": "Эспрессо",
                    "capuccino": "Капучино",
                    "cacao": "Какао",
...
function addButton(){
    ...
    newCoffee.id = `form${countOfCoffee}`;
    newCoffee.innerHTML = newCoffee.innerHTML.replace("Напиток №1", `Напиток №${countOfCoffee}`);
...
function showLightbox(){
    ...
    document.querySelector(".countOfCoffee").textContent = getText(countOfCoffee);
